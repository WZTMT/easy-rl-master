...
from codes.common.utils import plot_rewards
...
if __name__ == "__main__":
    ...
    cfg.model_path = curr_path + '/outputs/Pendulum-v0/20220801-101718/models/'
    cfg.result_path = curr_path + '/outputs/Pendulum-v0/20220801-101718/results/'
